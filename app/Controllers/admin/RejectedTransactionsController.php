...
class RejectedTransactionsController extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Rejected Transactions |  PhotoWithGarbGreh',
            'description' => '',
            'session' => \Config\Services::session(),
            'activelink' => 'rejectedtransactions'
        ];
        return view('pages/admin/rejectedtransactions', $data);
    }    
